...
:showusage
echo Usage:
echo nmexec_vpc ctlfile
goto exit

:run
set nmfe=C:\\nm74g64\\run\\nmfe74.bat
rem set I_MPI_AUTH_METHOD=delegate
rem set paraopts="-parafile=U:\mpiwini8.pnm" "[nodes]=15"
set run_dir=%~n1
set ctl_file=%run_dir%_vpc.ctl
set lst_file=%run_dir%_vpc.lst
